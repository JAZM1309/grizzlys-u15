...
## Version 1.5.4
- App-Version in der Info auf 1.5.4 aktualisiert
- Zwei Teamseiten-Buttons auf der Info-Seite für U15 A und U15 B

## Version 1.5.3
- PDF-Druck: Mehrfachauswahl der Filter Alle, U15 A, U15 B, Heim und Auswärts
- Team- und Heim/Auswärts-Filter können kombiniert werden, z. B. U15 A + Heim
...
## Änderungen Version 1.5.4 – EHV-Tabellen

- Im Spielplan wurden kompakte Links zu den offiziellen EHV-NRW-Tabellen ergänzt.
- **U15 A:** https://ehv-nrw.de/leagues/league/u15/lln/66/
- **U15 B:** https://ehv-nrw.de/leagues/league/u15/bzl/67/
- Die Verlinkung erfolgt ohne zusätzliche große Schaltflächen, damit der Spielplan übersichtlich bleibt.
